...
$_ = '‚ ‚¢‚¤‚¦‚¨‚©‚«‚­‚¯‚±';
if (HP15::substr($_,5) eq '‚©‚«‚­‚¯‚±') {
    print qq{ok - 11 HP15::substr(\$_,5) eq '‚©‚«‚­‚¯‚±' $^X $__FILE__\n};
}
else {
    print qq{not ok - 11 HP15::substr(\$_,5) eq '‚©‚«‚­‚¯‚±' $^X $__FILE__\n};
}

$_ = '‚ ‚¢‚¤‚¦‚¨‚©‚«‚­‚¯‚±';
if (HP15::substr($_,2,3) eq '‚¤‚¦‚¨') {
    print qq{ok - 12 HP15::substr(\$_,2,3) eq '‚¤‚¦‚¨' $^X $__FILE__\n};
}
else {
    print qq{not ok - 12 HP15::substr(\$_,2,3) eq '‚¤‚¦‚¨' $^X $__FILE__\n};
}

$_ = '‚ ‚¢‚¤‚¦‚¨‚©‚«‚­‚¯‚±';
if (HP15::substr($_,2,3,'‚³‚µ‚·‚¹‚»') eq '‚¤‚¦‚¨') {
    if ($_ eq '‚ ‚¢‚³‚µ‚·‚¹‚»‚©‚«‚­‚¯‚±') {
        print qq{ok - 13 HP15::substr(\$_,2,3,'‚³‚µ‚·‚¹‚»') eq '‚¤‚¦‚¨' $^X $__FILE__\n};
    }
    else {
        print qq{not ok - 13 HP15::substr(\$_,2,3,'‚³‚µ‚·‚¹‚»') eq '‚¤‚¦‚¨' $^X $__FILE__\n};
    }
}
else {
    print qq{not ok - 13 HP15::substr(\$_,2,3,'‚³‚µ‚·‚¹‚»') eq '‚¤‚¦‚¨' $^X $__FILE__\n};
...
$_ = '‚ ‚¢‚¤‚¦‚¨‚©‚«‚­‚¯‚±';
if (HP15::substr($_,-3) eq '‚­‚¯‚±') {
    print qq{ok - 14 HP15::substr(\$_,-3) eq '‚­‚¯‚±' $^X $__FILE__\n};
}
else {
    print qq{not ok - 14 HP15::substr(\$_,-3) eq '‚­‚¯‚±' $^X $__FILE__\n};
}

$_ = '‚ ‚¢‚¤‚¦‚¨‚©‚«‚­‚¯‚±';
if (HP15::substr($_,-5,3) eq '‚©‚«‚­') {
    print qq{ok - 15 HP15::substr(\$_,-5,3) eq '‚©‚«‚­' $^X $__FILE__\n};
}
else {
    print qq{not ok - 15 HP15::substr(\$_,-5,3) eq '‚©‚«‚­' $^X $__FILE__\n};
}

$_ = '‚ ‚¢‚¤‚¦‚¨‚©‚«‚­‚¯‚±';
if (HP15::substr($_,-5,3,'‚â‚ä‚æ') eq '‚©‚«‚­') {
    if ($_ eq '‚ ‚¢‚¤‚¦‚¨‚â‚ä‚æ‚¯‚±') {
        print qq{ok - 16 HP15::substr(\$_,-5,3,'‚â‚ä‚æ') eq '‚©‚«‚­' $^X $__FILE__\n};
    }
    else {
        print qq{not ok - 16 HP15::substr(\$_,-5,3,'‚â‚ä‚æ') eq '‚©‚«‚­' $^X $__FILE__\n};
    }
}
else {
    print qq{not ok - 16 HP15::substr(\$_,-5,3,'‚â‚ä‚æ') eq '‚©‚«‚­' $^X $__FILE__\n};
...
$_ = '‚ ‚¢‚¤‚¦‚¨‚©‚«‚­‚¯‚±';
if (HP15::substr($_,5,0,'‚â‚ä‚æ') eq '') {
    if ($_ eq '‚ ‚¢‚¤‚¦‚¨‚â‚ä‚æ‚©‚«‚­‚¯‚±') {
        print qq{ok - 18 HP15::substr(\$_,5,0,'‚â‚ä‚æ') eq '' $^X $__FILE__\n};
    }
    else {
        print qq{not ok - 18 HP15::substr(\$_,5,0,'‚â‚ä‚æ') eq '' $^X $__FILE__\n};
    }
}
else {
    print qq{not ok - 18 HP15::substr(\$_,5,0,'‚â‚ä‚æ') eq '' $^X $__FILE__\n};
...
if (HP15::substr($_,-5,0,'‚â‚ä‚æ') eq '') {
    if ($_ eq '‚ ‚¢‚¤‚¦‚¨‚â‚ä‚æ‚©‚«‚­‚¯‚±') {
        print qq{ok - 20 HP15::substr(\$_,-5,0,'‚â‚ä‚æ') eq '' $^X $__FILE__\n};
    }
    else {
        print qq{not ok - 20 HP15::substr(\$_,-5,0,'‚â‚ä‚æ') eq '' $^X $__FILE__\n};
    }
}
else {
    print qq{not ok - 20 HP15::substr(\$_,-5,0,'‚â‚ä‚æ') eq '' $^X $__FILE__\n};
