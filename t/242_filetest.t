...
if (-t ('file')) {
    if (Ehp15::t(_)) {
        print "ok - 18 Ehp15::t _ == -t _ $^X $__FILE__\n";
    }
    else {
        print "not ok - 18 Ehp15::t _ == -t _ $^X $__FILE__\n";
    }
}
else {
    if (Ehp15::t(_)) {
...
if (-u ('file')) {
    if (Ehp15::u(_)) {
        print "ok - 19 Ehp15::u _ == -u _ $^X $__FILE__\n";
    }
    else {
        print "not ok - 19 Ehp15::u _ == -u _ $^X $__FILE__\n";
    }
}
else {
    if (Ehp15::u(_)) {
...
if (-g ('file')) {
    if (Ehp15::g(_)) {
        print "ok - 20 Ehp15::g _ == -g _ $^X $__FILE__\n";
    }
    else {
        print "not ok - 20 Ehp15::g _ == -g _ $^X $__FILE__\n";
    }
}
else {
    if (Ehp15::g(_)) {
...
if (-k ('file')) {
    if (Ehp15::k(_)) {
        print "ok - 21 Ehp15::k _ == -k _ $^X $__FILE__\n";
    }
    else {
        print "not ok - 21 Ehp15::k _ == -k _ $^X $__FILE__\n";
    }
}
else {
    if (Ehp15::k(_)) {
...
$_ = -M 'file';
if (Ehp15::M(_) == $_) {
    print "ok - 22 Ehp15::M _ (@{[Ehp15::M _]}) == -M 'file' ($_) $^X $__FILE__\n";
}
else {
    print "not ok - 22 Ehp15::M _ (@{[Ehp15::M _]}) == -M 'file' ($_) $^X $__FILE__\n";
}

$_ = -A 'file';
if (Ehp15::A(_) == $_) {
    print "ok - 23 Ehp15::A _ (@{[Ehp15::A _]}) == -A 'file' ($_) $^X $__FILE__\n";
}
else {
    print "not ok - 23 Ehp15::A _ (@{[Ehp15::A _]}) == -A 'file' ($_) $^X $__FILE__\n";
}

$_ = -C 'file';
if (Ehp15::C(_) == $_) {
    print "ok - 24 Ehp15::C _ (@{[Ehp15::C _]}) == -C 'file' ($_) $^X $__FILE__\n";
}
else {
    print "not ok - 24 Ehp15::C _ (@{[Ehp15::C _]}) == -C 'file' ($_) $^X $__FILE__\n";
}
