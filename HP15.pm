...
the script was written in HP-15.
...
we're loving, so many users hope to write scripts in HP-15 encodings; without
giving up a whole new feature of Perl5.8, Perl5.10.

The HP-15 was developed in order to maintain backward compatibility. Generally,
